        ...
        <div class="card-body">
          <div class="d-flex align-items-start">
            ...
            <div class="author-info">
              <h2 class="mb-25">{{__('all.Create')}}</h2>
            </div>
            <br>
            <br>
            <br>
            ...
            <div class="row">
              <div class="col-md-6 col-12">
                <div class="mb-2">
                  ...
                  <input required type="text" id="name_ka" name="name_ka"  class="form-control" placeholder="{{__('all.Name')}} GE" value="{{$food->name_ka}}"/>
                </div>
              </div>
              <div class="col-md-6 col-12">
                <div class="mb-2">
                  <label class="form-label" for="name_ge">{{__('all.Name')}} EN:</label>
                  <input required type="text" id="name_en" name="name_en"  class="form-control" placeholder="{{__('all.Name')}} EN" value="{{$food->name_en}}"/>
                </div>
              </div>
              <div class="col-md-6 col-12">
                <div class="mb-2">
                  <label class="form-label" for="name_ge">{{__('all.Name')}} RU:</label>
                  <input required type="text" id="name_ru" name="name_ru"  class="form-control" placeholder="{{__('all.Name')}} RU" value="{{$food->name_ru}}"/>
                </div>
              </div>
              <div class="col-md-6 col-12">
                <div class="mb-2">
              ...
              <div class="col-md-6 col-12">
                  <div class="ing">{{__('all.Fasting')}}
                      <label class="containeri">
                        <input id='samarxvo' type='hidden'  name="samarxvo" value="0">
                        @if($food->samarxvo == 1)
                          <input type="checkbox"  name="samarxvo" value="1" checked>
                        @else
                  ...
                  <div class="ing">{{__('all.Dietary')}}
                      <label class="containeri">
                        <input id='dieturi' type='hidden'  name="dieturi" value="0">
                        @if($food->dieturi == 1)
                          <input type="checkbox"  name="dieturi" value="1" checked>
                        @else
                  ...
                  <div class="ing">{{__('all.Vegetarian')}}
                      <label class="containeri">
                        <input id='vegetarianuli' type='hidden'  name="vegetarianuli" value="0">
                        @if($food->vegetarianuli == 1)
                          <input type="checkbox"  name="vegetarianuli" value="1" checked>
                        @else
              ...
              <div style="width:100%;margin: 10px 15px; max-height:260px; overflow-y: scroll;" id="ingredients_div">
                  ...
                  @foreach($ingredient_all as $key => $item)
                    ...
                    @if(session('locale') == 'ka')
                      ...
                      <label class="containeri"> 
                        <input  type='hidden'  name="ing_{{ $item->id }}" value="0">
                        @if(!empty($tmp) && (isset($tmp[$item->id])))
                          <input type="checkbox" id="ing_{{ $item->id }}"  name="ing_{{ $item->id }}" value="1" checked>
                        @else
            ...
            <div class="row">
                ...
                <div class="border rounded p-2">
                  ...
                  <div class="d-flex flex-column flex-md-row">
                    <img src="{{asset('assets/images/foods')}}/{{ $food->file_name}}" id="blog-feature-image" class="rounded me-2 mb-1 mb-md-0" width="170" height="110" >
